...
include $localConfig = __DIR__.'/../../../app/Config/App.config.php';
...
$baseUrl = 'http://dev.bybo.com/public/uploads/img/';

$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => $baseUrl.'post/post_img',
    'root'         => __DIR__.'/../../../public/uploads/img/post/post_img', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0777,
